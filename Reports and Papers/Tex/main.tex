...
\titleheader{2017 7th International Symposium on Embedded computing \& system Design}
\begin{document}
...
\bibitem{b10} Becker M., Krömker M., Szczerbicka H. (2015) ``Evaluating Heuristic Optimization, Bio-Inspired and Graph-Theoretic Algorithms for the Generation of Fault-Tolerant Graphs with Minimal Costs,''. In: Kim K. (eds) Information Science and Applications. Lecture Notes in Electrical Engineering, vol 339. Springer, Berlin, Heidelberg, pp 1033-1041
